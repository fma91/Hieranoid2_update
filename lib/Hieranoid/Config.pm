...
has 'substitutionMatrixPath', is => 'rw', isa => 'Str';

has 'addNonMatchingSequences', is => 'rw', isa => 'Str';   
has 'computationMode', is => 'rw', isa => 'Str';
has 'sshCluster', is => 'rw', isa => 'ArrayRef[Str]';
has 'pathCluster', is => 'rw', isa => 'Str';
has 'tempDir', is => 'rw', isa => 'Str';
has 'libCluster', is => 'rw', isa => 'Str';
has 'afsCluster', is => 'rw', isa => 'Str';
...
sub BUILD {
      ...
      $self->substitutionMatrixPath($Configuration::substitutionMatrixPath);
      $self->computationMode($Configuration::computationMode);
      $self->sshCluster($Configuration::sshCluster);
      $self->pathCluster($Configuration::pathCluster);
      $self->tempDir($Configuration::tempDir);
      $self->libCluster($Configuration::libCluster);
      $self->afsCluster($Configuration::afsCluster);
      ...
      die 'No substitutionMatrixPath specified\n' if(!$self->substitutionMatrixPath);
      die 'No computation_mode specified\n' if(!$self->computationMode);
      die 'No sshCluster specified\n' if(!$self->sshCluster);
      die 'No pathCluster specified\n' if(!$self->pathCluster);
      die 'No tempDir specified\n' if(!$self->tempDir); 
      die 'No libCluster specified\n' if(!$self->libCluster);
      die 'No afsCluster specified\n' if(!$self->afsCluster);
