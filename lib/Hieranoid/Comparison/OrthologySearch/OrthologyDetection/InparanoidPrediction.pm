...
sub start{
 ...
 #        print "\tChecking input files\n";
        ...
        my $inparanoid_call = $self->configuration->perl." -I ".$self->configuration->rootDirectory."lib ".$self->configuration->rootDirectory."inparanoid.pl -q ".$self->nodeObject->rightDaughter->fileInformation->sequenceSearchInputFile." -d ".$self->nodeObject->leftDaughter->fileInformation->sequenceSearchInputFile;
